...
class Config:
    ...
    def __init__(self, max_weekly_hours=15, max_daily_courses=2,max_morning_courses=2, max_afternoon_courses=2, lunch_break=None, forbidden_slot=None):
        self.max_weekly_hours = max_weekly_hours
        self.max_daily_courses = max_daily_courses
