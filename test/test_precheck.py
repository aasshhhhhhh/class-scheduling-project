...
def prepare_timetable_data(schedule):
    ...
    ซึ่งเป็น format ที่ฟังก์ชัน validate_pre_schedule ต้องการ
    """
...
if __name__ == "__main__":
    print("--- Starting Pre-Schedule Validation Test ---")
    ...
    # 3. เรียก validate_pre_schedule
    print("\n--- Running validate_post_schedule ---")
    # สังเกตลำดับ Argument: timetable, time_slots_list, instructors, config_dict
    valid, msg = check_assign_rules(instructors, course, slot_ids, time_slots_map, year_schedule, config)
